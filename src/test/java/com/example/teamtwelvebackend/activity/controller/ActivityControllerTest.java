...
class ActivityControllerTest {
    ...
    void list() throws Exception {
        ...
        List<Activity> list = List.of(
            new Activity(1L, "스피드게임", "자유 퀴즈를 만들고 정답을 맞혀보세요", LocalDateTime.now()),
            new Activity(2L, "두 개의 진실 하나의 거짓말", "세 가지 정보 중 하나의 거짓을 찾아보세요", LocalDateTime.now()),
            new Activity(3L,"감사 서클", "참여자의 이름을 적어주세요", LocalDateTime.now()),
            new Activity(4L,"기분 체크인", "참여자의 오늘의 기분을 알아보세요!", LocalDateTime.now()),
            new Activity(5L,"미니 네트워킹", "그룹을 구성하여 네트워킹을 시작하세요", LocalDateTime.now()),
            new Activity(6L,"이미지 게임", "가장 ~ 할 것 같은 사람은?", LocalDateTime.now())
        );
